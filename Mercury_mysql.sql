...
-- -----------------------------------------------------
-- Table `mercury`.`volunteer_roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mercury`.`volunteer_roles` (
  `volunteer_roles_id` INT NOT NULL,
  `volunteer_roles_name` VARCHAR(255) NOT NULL,
  `create_datetime` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`volunteer_roles_id`));


-- -----------------------------------------------------
-- Table `mercury`.`volunteer_has_roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mercury`.`volunteer_has_roles` (
  `volunteer_id` INT NOT NULL,
  `volunteer_roles_id` INT NOT NULL,
  `create_datetime` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`volunteer_id`, `volunteer_roles_id`),
  INDEX `fk_volunteer_has_volunteer_roles_volunteer_roles1_idx` (`volunteer_roles_id` ASC),
  INDEX `fk_volunteer_has_volunteer_roles_volunteer1_idx` (`volunteer_id` ASC),
  CONSTRAINT `fk_volunteer_has_volunteer_roles_volunteer1`
    FOREIGN KEY (`volunteer_id`)
    REFERENCES `mercury`.`volunteer` (`volunteer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_volunteer_has_volunteer_roles_volunteer_roles1`
    FOREIGN KEY (`volunteer_roles_id`)
    REFERENCES `mercury`.`volunteer_roles` (`volunteer_roles_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
