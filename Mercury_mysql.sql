CREATE TABLE `volunteer` (
	...
	`slack_id` INT,
	`github_id` INT,
	`is_hatchling` bool NOT NULL DEFAULT false,
	`developer_level` INT,
...
CREATE TABLE `volunteer_reports` (
	`id` INT NOT NULL AUTO_INCREMENT,
	`data_entry_date` DATETIME NOT NULL,
	`data_volunteer_user_id` INT NOT NULL,
	`volunteer_id` INT NOT NULL,
	`name` TEXT NOT NULL,
	`email` TEXT NOT NULL,
	...
	`will_be_active_on_slack` TEXT NOT NULL,
	PRIMARY KEY (`id`)
);
...
ALTER TABLE `volunteer` ADD CONSTRAINT `volunteer_fk0` FOREIGN KEY (`position`) REFERENCES `position`(`id`);

ALTER TABLE `volunteer` ADD CONSTRAINT `volunteer_fk1` FOREIGN KEY (`volunteer_status`) REFERENCES `volunteer_status_types`(`id`);
...
ALTER TABLE `volunteer_comment` ADD CONSTRAINT `volunteer_comment_fk2` FOREIGN KEY (`comment_id`) REFERENCES `comment`(`id`);
...
ALTER TABLE `volunteer_announcement` ADD CONSTRAINT `volunteer_announcement_fk1` FOREIGN KEY (`announcement`) REFERENCES `announcement`(`id`);
...
ALTER TABLE `announcement` ADD CONSTRAINT `announcement_fk1` FOREIGN KEY (`announcement_type`) REFERENCES `announcement_type`(`id`);
...
ALTER TABLE `project_activity_announcement` ADD CONSTRAINT `project_activity_announcement_fk1` FOREIGN KEY (`announcement_type`) REFERENCES `project_announcement_type`(`id`);
...
ALTER TABLE `project_activity` ADD CONSTRAINT `project_activity_fk2` FOREIGN KEY (`activity_type`) REFERENCES `activity_type`(`id`);
...
ALTER TABLE `project` ADD CONSTRAINT `project_fk1` FOREIGN KEY (`status`) REFERENCES `project_status`(`id`);

ALTER TABLE `project` ADD CONSTRAINT `project_fk2` FOREIGN KEY (`project_category`) REFERENCES `project_category`(`id`);
...
ALTER TABLE `project_team_request` ADD CONSTRAINT `project_team_request_fk1` FOREIGN KEY (`project`) REFERENCES `project`(`project_id`);
...
ALTER TABLE `project_team_request` ADD CONSTRAINT `project_team_request_fk3` FOREIGN KEY (`request_status`) REFERENCES `request_status`(`id`);
...
ALTER TABLE `project_sub_activity` ADD CONSTRAINT `project_sub_activity_fk1` FOREIGN KEY (`platform`) REFERENCES `platform`(`id`);

ALTER TABLE `project_sub_activity` ADD CONSTRAINT `project_sub_activity_fk2` FOREIGN KEY (`project_activity`) REFERENCES `project_activity`(`id`);

ALTER TABLE `project_sub_activity` ADD CONSTRAINT `project_sub_activity_fk3` FOREIGN KEY (`approved_by`) REFERENCES `volunteer`(`volunteer_id`);

ALTER TABLE `project_sub_activity` ADD CONSTRAINT `project_sub_activity_fk4` FOREIGN KEY (`lead_mentor`) REFERENCES `volunteer`(`volunteer_id`);

ALTER TABLE `project_sub_activity` ADD CONSTRAINT `project_sub_activity_fk5` FOREIGN KEY (`assistant_mentor`) REFERENCES `volunteer`(`volunteer_id`);
...
ALTER TABLE `project_team` ADD CONSTRAINT `project_team_fk3` FOREIGN KEY (`member_role`) REFERENCES `member_role`(`id`);

ALTER TABLE `project_team` ADD CONSTRAINT `project_team_fk4` FOREIGN KEY (`member_status`) REFERENCES `member_status`(`id`);

ALTER TABLE `project_team` ADD CONSTRAINT `project_team_fk5` FOREIGN KEY (`platform`) REFERENCES `platform`(`id`);

ALTER TABLE `volunteer_reports` ADD CONSTRAINT `volunteer_reports_fk0` FOREIGN KEY (`data_volunteer_user_id`) REFERENCES `volunteer`(`volunteer_id`);

ALTER TABLE `volunteer_reports` ADD CONSTRAINT `volunteer_reports_fk1` FOREIGN KEY (`volunteer_id`) REFERENCES `volunteer`(`volunteer_id`);

ALTER TABLE `volunteer_reports` ADD CONSTRAINT `volunteer_reports_fk2` FOREIGN KEY (`intake_volunteer_type`) REFERENCES `report_volunteer_type`(`id`);

ALTER TABLE `volunteer_reports` ADD CONSTRAINT `volunteer_reports_fk3` FOREIGN KEY (`platform`) REFERENCES `platform`(`id`);

ALTER TABLE `volunteer_reports` ADD CONSTRAINT `volunteer_reports_fk4` FOREIGN KEY (`developer_type`) REFERENCES `developer_types`(`id`);

ALTER TABLE `volunteer_reports` ADD CONSTRAINT `volunteer_reports_fk5` FOREIGN KEY (`interested_in`) REFERENCES `report_volunteer_interest`(`id`);
...
ALTER TABLE `entrollment_form` ADD CONSTRAINT `entrollment_form_fk2` FOREIGN KEY (`primary_join_reason`) REFERENCES `joining_reason`(`id`);

ALTER TABLE `entrollment_form` ADD CONSTRAINT `entrollment_form_fk3` FOREIGN KEY (`secondary_join_reason`) REFERENCES `joining_reason`(`id`);

ALTER TABLE `entrollment_form` ADD CONSTRAINT `entrollment_form_fk4` FOREIGN KEY (`intake_process_step`) REFERENCES `intake_process_steps`(`id`);

ALTER TABLE `entrollment_form` ADD CONSTRAINT `entrollment_form_fk5` FOREIGN KEY (`developer_self_level`) REFERENCES `developer_levels`(`id`);
...
ALTER TABLE `verification_code` ADD CONSTRAINT `verification_code_fk0` FOREIGN KEY (`id`) REFERENCES `volunteer`(`volunteer_id`);
