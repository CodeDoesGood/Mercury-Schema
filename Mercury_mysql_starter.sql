...
INSERT INTO volunteer (created_datetime, data_entry_user_id, username, password, position_id, volunteer_status, name, about, email, phone, location, timezone, linked_in_id, slack_id, github_id, developer_level, admin_portal_access, admin_overall_level, salt, verified) VALUES (
  '2001-06-22',
  1,
  'user1',
...
INSERT INTO project (project_id, created_datetime, data_entry_user_id, title, status, project_category, hidden, image_directory, description, summary) VALUES (
  NULL,
  '2017-12-04',
  1,
  'Helping Hands',
